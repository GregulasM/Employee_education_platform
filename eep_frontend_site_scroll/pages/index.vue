  ...
  <div class="shadow-md shadow-orange-200 mt-8 ml-8 mr-8 rounded-lg bg-orange-50 opacity-90 h-min">
    ...
    <div class="flex-col p-2 font-semibold text-shadow-lg rounded-box shadow-md text-black">
      ...
      <p class="flex-col p-2 font-medium shadow-md text-black text-md whitespace-pre-line ">
        ...
        Morbi non placerat metus, ut efficitur nulla. Aliquam maximus tellus eros, ac suscipit quam faucibus a. Aenean in eleifend metus.  Phasellus nec felis nibh. <br>

        Pellentesque ullamcorper urna sed viverra blandit. Aliquam sodales, eros at tristique cursus, magna enim condimentum ante, sit amet euismod dui mi nec sem. Quisque a pellentesque leo. Phasellus sed justo purus. Curabitur sed sapien orci. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
